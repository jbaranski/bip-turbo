-- Rewrite search function to use entity IDs as base-level filters
...
BEGIN
  ...
  matched_tracks AS (
    ...
    SELECT 
      ...
      CASE WHEN song_ids IS NOT NULL THEN true ELSE false END as is_exact_song_match
  ...
  segue_matches AS (
    ...
    SELECT DISTINCT
      ...
      CASE 
        WHEN mt1.is_exact_song_match AND mt2.is_exact_song_match THEN 150
        WHEN mt1.is_exact_song_match OR mt2.is_exact_song_match THEN 120
        ELSE 100
      END as segue_score
