...
const MovieScores: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Live Movie Scores</h1>
        ...
        title={
          <div className="flex flex-col sm:flex-row sm:items-center">
            ...
            <Link
              ...
              className="text-blue-600 hover:underline text-lg sm:text-2xl"
            >
      ...
      <MovieCard title="Fall 2001 Movie Jams">
        ...
        <ul className="list-disc pl-8 space-y-2 mb-4 text-gray-800">
          <li>
            Disney's Alice in Wonderland -{" "}
            <Link to="/shows/2001-10-31-woodmen-of-the-world-hall-eugene-or" className="text-blue-600 hover:underline">
              10/31/01 Woodmen of the World Hall, Eugene, OR
            </Link>
          </li>
          <li>
            It's The Great Pumpkin, Charlie Brown -{" "}
            <Link to="/shows/2001-11-01-wett-bar-vancouver-bc" className="text-blue-600 hover:underline">
              11/01/01 The Wett Bar, Vancouver, BC
            </Link>
          </li>
          <li>
            Koyaanisqatsi -{" "}
            <Link to="/shows/2001-11-02-crystal-ballroom-portland-or" className="text-blue-600 hover:underline">
              11/02/01 Crystal Ballroom, Portland, OR
            </Link>
          </li>
          <li>
            Run Lola Run -{" "}
            <Link to="/shows/2001-11-03-king-cat-theatre-seattle-wa" className="text-blue-600 hover:underline">
