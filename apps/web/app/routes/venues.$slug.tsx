    ...
    <div className="p-6">
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-2 text-gray-400">
          ...
          <p>{[venue.city, venue.state, venue.country].filter(Boolean).join(", ")}</p>
        </div>
        ...
        <dl className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatBox
            ...
            value={
              stats.firstShow
                ? stats.firstShow.toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric",
                    year: "numeric",
                    timeZone: "UTC",
          ...
          <StatBox
            ...
            value={
              stats.lastShow
                ? stats.lastShow.toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric",
                    year: "numeric",
                    timeZone: "UTC",
          ...
          <StatBox
            ...
            sublabel={stats.yearsPlayed.slice(0, 3).join(", ") + (stats.yearsPlayed.length > 3 ? "..." : "")}
          />
        </dl>

        <div className="space-y-8">
          <h2 className="text-2xl font-semibold">Shows at {venue.name}</h2>

          {setlists.length === 0 ? (
            <p className="text-gray-400">No shows found for this venue.</p>
          ) : (
            <div className="space-y-6">
              {setlists.map((setlist) => (
                <VenueSetlistCard key={setlist.show.id} setlist={setlist} />
              ))}
            </div>
          )}
        </div>
