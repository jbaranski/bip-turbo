...
const Mixes: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Running Mixes</h1>
      ...
      <Card title="About These Mixes">
        ...
        <p>These mixes are composed of hand-selected jams. In most cases, they segue into one another.</p>
        <p>
          ...
          They've gotten me across the finish line in countless races, and I have yet to find any music more conducive
          to cardio.
        </p>
        <p>
          I hope you enjoy these mixes as much as I do! If I've missed any mixes (or you've created a new one that you'd
          like to add), please let me know. If one of these mixes is yours and you'd like credit for it, don't hesitate
          to reach out!
        </p>
        <p>
          -{" "}
