...
export default function Tractorbeam() {
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-blue-900 mb-6">Tractor Beam</h1>

      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <p>
          Tractorbeam, like{" "}
          <Link to="/resources/the-perfume" className="text-blue-600 hover:text-blue-800 hover:underline">
            The Perfume
          </Link>
          ...
          at Ontourage in Chicago, IL Tractorbeam played instrumental versions of Disco Biscuits originals and covers
          until switching up their format in 2019.
        </p>

        <p>
          It was evident that this project served as a creative spark for the band, as they played three memorable shows
          in 2007, following their Chicago debut.{" "}
          <Link
        ...
        <p>
          In addition to the TB standalone shows, every Disco Biscuits show since 11/14/19 has included a Tractorbeam
          segment mid-second or third set.
        </p>
      </div>
    </div>
  );
