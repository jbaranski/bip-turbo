...
export default function ThinkTank() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold text-blue-900 mb-6">Think Tank Dubs</h1>

      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <h2 className="text-2xl font-semibold text-blue-800 mb-4">The Basement Sessions</h2>
        ...
        <div className="mt-6">
          <h3 className="text-xl font-semibold text-blue-800 mb-3">Think Tank Dubs Starter Pack:</h3>
